...
Marzban поставляется с двумя мощными интерфейсами командной строки для администраторов:

## Marzban CLI

Marzban включает современный, типобезопасный CLI, построенный с помощью Typer, который предоставляет богатый вывод и красивые таблицы. CLI позволяет управлять Marzban из командной строки с такими функциями, как:

- **Управление администраторами**: создание, изменение, удаление и список учетных записей администраторов
- **Управление пользователями**: список пользователей с различными фильтрами и пагинацией
- **Управление узлами**: список узлов
- **Информация о системе**: мониторинг состояния системы и статистики

Если вы установили Marzban с помощью скрипта установки, вы можете получить доступ к командам CLI, выполнив:
...
Marzban также включает встроенный текстовый пользовательский интерфейс (TUI) под названием `marzban-tui`, который предоставляет интерактивный, современный интерфейс командной строки, построенный с помощью Textual. TUI предлагает:

- **Интерактивный интерфейс**: современный, отзывчивый дизайн с поддержкой темной темы
- **Горячие клавиши**: быстрая навигация и команды
- **Обновления в реальном времени**: живые обновления данных и мониторинг
- **Богатая визуализация**: красивые таблицы и представление данных

Если вы установили Marzban с помощью скрипта установки, вы можете получить доступ к TUI, выполнив:
...
- **Управление администраторами**: создание, изменение, удаление и управление учетными записями администраторов
- **Управление пользователями**: просмотр и управление учетными записями пользователей
- **Мониторинг системы**: состояние системы в реальном времени и статистика
- **Интерактивная навигация**: простые в использовании горячие клавиши

Для получения более подробной информации вы можете прочитать:
- [Документация Marzban CLI](./cli/README.md)
- [Документация Marzban TUI](./tui/README.md)
