...
- [رابط خط فرمان (CLI) و رابط کاربری متنی (TUI) مرزبان](#رابط-خط-فرمان-cli-و-رابط-کاربری-متنی-tui-مرزبان)
  - [رابط خط فرمان (CLI) مرزبان](#رابط-خط-فرمان-cli-مرزبان)
  - [رابط کاربری متنی (TUI) مرزبان](#رابط-کاربری-متنی-tui-مرزبان)
    - [ویژگی‌های TUI](#ویژگیهای-tui)
...
- **رابط کاربری متنی تعاملی (TUI)** داخلی
...
اگر می خواهید از `marzban-tui` استفاده کنید، باید آن را به یک فایل در `$PATH` خود لینک و قابل اجرا (executable) کنید. سپس تکمیل خودکار (auto-completion) آن را نصب کنید:
...
# رابط خط فرمان (CLI) و رابط کاربری متنی (TUI) مرزبان

مرزبان دارای دو رابط خط فرمان قدرتمند برای مدیران است:

## رابط خط فرمان (CLI) مرزبان

مرزبان شامل یک CLI مدرن و type-safe است که با Typer ساخته شده و خروجی غنی و جداول زیبا ارائه می‌دهد. CLI به شما امکان مدیریت مرزبان را از خط فرمان با ویژگی‌هایی مانند:

- **مدیریت مدیران**: ایجاد، ویرایش، حذف و لیست کردن حساب‌های مدیر
- **مدیریت کاربران**: لیست کردن کاربران با فیلترهای مختلف و صفحه‌بندی
- **مدیریت نودها**: لیست کردن نودها
- **اطلاعات سیستم**: نظارت بر وضعیت سیستم و آمار

اگر مرزبان را با اسکریپت نصب آسان نصب کرده‌اید، می‌توانید با اجرای دستور زیر به دستورات CLI دسترسی پیدا کنید:

```bash
marzban cli [OPTIONS] COMMAND [ARGS]...
```

## رابط کاربری متنی (TUI) مرزبان

مرزبان همچنین شامل یک رابط کاربری متنی (TUI) داخلی به نام `marzban-tui` است که یک رابط خط فرمان تعاملی و مدرن ارائه می‌دهد که با Textual ساخته شده است. TUI ارائه می‌دهد:

- **رابط تعاملی**: طراحی مدرن و responsive با پشتیبانی از حالت تاریک
- **کلیدهای میانبر**: ناوبری سریع و دستورات
- **به‌روزرسانی‌های real-time**: به‌روزرسانی‌های زنده داده و نظارت
- **تجسم غنی**: جداول زیبا و ارائه داده

اگر مرزبان را با اسکریپت نصب آسان نصب کرده‌اید، می‌توانید با اجرای دستور زیر به TUI دسترسی پیدا کنید:
...
- **مدیریت مدیران**: ایجاد، ویرایش، حذف و مدیریت حساب‌های مدیر
- **مدیریت کاربران**: مشاهده و مدیریت حساب‌های کاربر
- **نظارت بر سیستم**: وضعیت سیستم real-time و آمار
- **ناوبری تعاملی**: کلیدهای میانبر آسان برای استفاده

برای اطلاعات بیشتر، می‌توانید مطالعه کنید:
- [مستندات CLI مرزبان](./cli/README.md)
- [مستندات TUI مرزبان](./tui/README.md)
