...
- [رابط خط فرمان (TUI) مرزبان](#رابط-خط-فرمان-tui-مرزبان)
...
# رابط خط فرمان (TUI) مرزبان

مرزبان دارای یک رابط خط فرمان (Text User Interface / TUI) داخلی است که به مدیران اجازه می دهد با مرزبان ارتباط مستقیم داشته باشند.

رابط خط فرمان (TUI) مرزبان از طریق دستور `marzban-tui` هرکجا در دسترس خواهد بود!

برای کسب اطلاعات بیشتر می توانید [مستندات TUI مرزبان](./tui/README.md) را مطالعه کنید.
